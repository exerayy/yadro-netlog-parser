...
- host1 (LID=1) → switch3 (LID=11)  // разница 10 (меньше нет)
...
**Топологическая близость** - разница LID ≤ 2:
- switch3 (LID=11) → switch4 (LID=12)  // разница 1
- switch3 (LID=11) → switch2 (LID=13)  // разница 2
- switch4 (LID=12) → switch2 (LID=13)  // разница 1
- switch2 (LID=13) → switch1 (LID=22)  // разница 9 (не подходит, слишком большая разница!)

Порог 2 выбран эмпирически для охвата многоуровневых топологий без ложных связей.
...
- Изолированные узлы (разница LID > 2 без прямых соединений) не включаются в граф
